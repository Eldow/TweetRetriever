...
public class Constants {
	...
	public class General {
		...
		public static final String ACTION_NEW_TWEETS = "New Tweets";
		public static final String ACTION_NEW_TWEETS_EXTRA_NB_TWEETS = "New tweets nb : ";
	}
	...
	public class Twitter {
		...
		public static final long POLLING_DELAY = 3000;
	}
